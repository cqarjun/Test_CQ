...
creator.gui.screen qml3f30189df46d42ca930c9eef5c157c66 "Parabank Welcome"
{
	creator.gui.form qmlad381e3b2e3a40e9a0dad0914377926f "Customer Login"
	{
		...
		"Forgot login info?"
			status = dontcare;
		creator.gui.textbox qml13660844712e4b3eb359aa3c2cc982bc "rfaid\\"
			type = String
			status = dontcare;
		creator.gui.textbox qmlb527449149ee4dd08b9e2a61d7d82a2e "Geo"
			type = String
			status = dontcare;
		creator.gui.textbox qml747c40f882b040e9977daadf5e35a182 "Continent"
			type = String
			status = dontcare;
	}
...
creator.customaction qmld9b7f1e8c91244b5a25f1a03606d3450 "enter URL"
	...
	shortform = "EU"
	direction = in
	tokens = [ reference qml2e0d4a6c4e074844972268aa998fb079 literal " " ]
{
...
creator.customaction qml3b1143b1446642148e1e75566ae6825c "Account Created"
	...
	shortform = "AC"
	direction = out
	tokens = [ reference qmlc2650154957f474d92f2afee7cda8599 literal "  " ]
{
...
creator.customaction qml75da3bcb4a384169837297d2eb2f9dc6 "Invalid Credentials"
	...
	shortform = "IC"
	direction = out
	tokens = [ reference qml663600a69cc84e5bb51bb2eae9220560 literal "  " ]
{
...
qml41715b6ddd1f4bc586c2bf727e515e26 literal " " ]
{
...
creator.customaction qmlf9f4491cda8f44e6acb12bb05f6867fc "Invalid Register"
	...
	shortform = "IR"
	direction = out
	tokens = [ reference qml349b55eb1670431e958fb6403a556d67 literal " " ]
{
...
qml6494dc53c82449b4a3077910ea7877f6 literal " " ]
{
...
qml3c26634a26fd485e94bd46963814df93 literal " " ]
{
...
creator.enum qml37ac8eb6ca47468fa55a794e924d8dff "From Account"
{
	...
	creator.enumerationvalue qml3eee26234ab840878e3d4e5ba7aabba5 "1234";
}
...
"Bill Payment Complete"
	...
	shortform = "BP"
	direction = out
	tokens = [ reference qmle2c78a1b40b540848a15855488a0bb9c literal " " ]
{
...
qml9235abbdf8224c78851d8b62d09e5a1f literal " " ]
{
...
qmlc99ccd5068b84550bad97db72239a2f9 literal " " ]
{
...
creator.customaction qml8b8c7a91c75d44098c9dc737c597d785 "Profile Updated"
	...
	shortform = "PF"
	direction = out
	tokens = [ reference qml833f8d53ce524b48a10d924cdc8a7301 literal " " ]
{
...
qml3b7be46f9c434384b8431418e102c6d7 literal " " ]
{
...
qml64bf5ccef6c04033b492899a3ec5762c literal "  " ]
{
...
qml948092665c1942d09efff40b4fd4210e
	...
	shortform = "CT"
	direction = in
	tokens = [ reference qml4cee08d3232a44a19c986b1a74d7c2e9 literal " " ]
{
...
qml24dc457d8dba429f909a0f480de00e9d literal " " ]
{
...
creator.customaction qml0327dcab1d8043e6b75b597c307b0284 "Transaction Error "
	...
	shortform = "TE"
	direction = out
	tokens = [ reference qmlc3734b451e6142ceabd6aedbcd655080 literal " " ]
{
	creator.primitivefield qmlc3734b451e6142ceabd6aedbcd655080 "Error"
		type = String;
}
creator.gui.screen qml_ParaBankWelcomeOnlinePageParaBankWelcomeOnline
"ParaBank | Welcome | OnlinePageParaBank | Welcome | Online"
{
	creator.gui.hyperlink
	qml_hyperlinkParaBankWelcomeOnlineLinkParaBankWelcomeOnlineRegister
	"Register"
		status = dontcare;
}
creator.gui.screen qml_ParaBankWelcomeOnlinePageParaBankUpdateProfile
"ParaBank | Welcome | OnlinePageParaBank | Update Profile"
{
	creator.gui.form qml_formParaBankUpdateProfileParaBankUpdateProfilePage
	"ParaBank | Update Profile"
	{
		creator.gui.textbox
		qml_textboxParaBankWelcomeOnlineWebEditParaBankUpdateProfilecustomeraddresszipCode
		"customer.address.zipCode"
			type = String
			status = dontcare;
		creator.gui.button
		qml_buttonParaBankWelcomeOnlineWebButtonParaBankUpdateProfileUpdateProfile
		"Update Profile"
			status = dontcare;
	}
}
creator.gui.screen
qml_ParaBankWelcomeOnlineBrowserParaBankWelcomeOnlineBrowser
"ParaBank | Welcome | Online Browser"
{
}
creator.gui.screen qml_ParaBankRegisterforPageParaBankRegisterfor
"ParaBank | Register forPageParaBank | Register for"
{
	creator.gui.form qml_formParaBankRegisterforParaBankRegisterforPage
	"ParaBank | Register for"
	{
		creator.gui.textbox
		qml_textboxParaBankRegisterforWebEditParaBankRegisterforrepeatedPassword
		"repeatedPassword"
			type = String
			status = dontcare;
		creator.gui.textbox
		qml_textboxParaBankRegisterforWebEditParaBankRegisterforcustomerusername
		"customer.username"
			type = String
			status = dontcare;
		creator.gui.textbox
		qml_textboxParaBankRegisterforWebEditParaBankRegisterforcustomerssn
		"customer.ssn"
			type = String
			status = dontcare;
		creator.gui.textbox
		qml_textboxParaBankRegisterforWebEditParaBankRegisterforcustomerphoneNumber
		"customer.phoneNumber"
			type = String
			status = dontcare;
		creator.gui.textbox
		qml_textboxParaBankRegisterforWebEditParaBankRegisterforcustomerpassword
		"customer.password"
			type = String
			status = dontcare;
		creator.gui.textbox
		qml_textboxParaBankRegisterforWebEditParaBankRegisterforcustomerlastName
		"customer.lastName"
			type = String
			status = dontcare;
		creator.gui.textbox
		qml_textboxParaBankRegisterforWebEditParaBankRegisterforcustomerfirstName
		"customer.firstName"
			type = String
			status = dontcare;
		creator.gui.textbox
		qml_textboxParaBankRegisterforWebEditParaBankRegisterforcustomeraddresszipCode
		"customer.address.zipCode"
			type = String
			status = dontcare;
		creator.gui.textbox
		qml_textboxParaBankRegisterforWebEditParaBankRegisterforcustomeraddressstreet
		"customer.address.street"
			type = String
			status = dontcare;
		creator.gui.textbox
		qml_textboxParaBankRegisterforWebEditParaBankRegisterforcustomeraddressstate
		"customer.address.state"
			type = String
			status = dontcare;
		creator.gui.textbox
		qml_textboxParaBankRegisterforWebEditParaBankRegisterforcustomeraddresscity
		"customer.address.city"
			type = String
			status = dontcare;
		creator.gui.button
		qml_buttonParaBankRegisterforWebButtonParaBankRegisterforRegister "Register"
			status = dontcare;
	}
}
creator.gui.screen qml_ParaBankRegisterforPageParaBankProfileUpdated
"ParaBank | Register forPageParaBank | Profile Updated"
{
	creator.gui.hyperlink
	qml_hyperlinkParaBankRegisterforLinkParaBankProfileUpdatedLogOut "Log Out"
		status = dontcare;
}
creator.gui.screen qml_ParaBankRegisterforBrowserParaBankRegisterforBrowser
"ParaBank | Register for Browser"
{
}
creator.gui.screen qml_ParaBankCustomerCreatedPageParaBankCustomerCreated
"ParaBank | Customer CreatedPageParaBank | Customer Created"
{
	creator.gui.hyperlink
	qml_hyperlinkParaBankCustomerCreatedLinkParaBankCustomerCreatedAccountsOverview
	"Accounts Overview"
		status = dontcare;
}
creator.gui.screen qml_ParaBankCustomerCreatedPageParaBankAccountsOverview
"ParaBank | Customer CreatedPageParaBank | Accounts Overview"
{
	creator.gui.hyperlink
	qml_hyperlinkParaBankCustomerCreatedLinkParaBankAccountsOverviewUpdateContactInfo
	"Update Contact Info"
		status = dontcare;
}
creator.gui.screen
qml_ParaBankCustomerCreatedBrowserParaBankCustomerCreatedBrowser
"ParaBank | Customer Created Browser"
{
}
creator.gui.screen qmlb42a5b531ae645dc8bda5b1017bd79cd "test"
{
	creator.gui.button qmla61fd4cee6bc43818d382fc6e9e5ff15 "test"
		status = dontcare;
}